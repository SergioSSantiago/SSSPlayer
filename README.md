...
**Latest release: [v1.1.27](https://github.com/SergioSSantiago/SSSPlayer/releases/tag/v1.1.27)**  
Download: `SSSPlayer-1.1.27.vpk`
...
- **Latest VPK:** [SSSPlayer-1.1.27.vpk](https://github.com/SergioSSantiago/SSSPlayer/releases/download/v1.1.27/SSSPlayer-1.1.27.vpk)
...
The packaged file is `SSSPlayer-1.1.27.vpk` (version embedded in the filename).
