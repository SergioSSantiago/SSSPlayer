...
**Latest release: [v1.1.0](https://github.com/SergioSSantiago/SSSPlayer/releases/tag/v1.1.0)**  
Download: `SSSPlayer-1.1.0.vpk`
...
The packaged file is `SSSPlayer-1.1.0.vpk` (version embedded in the filename).
