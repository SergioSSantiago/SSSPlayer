...
**Latest release: [v1.1.23](https://github.com/SergioSSantiago/SSSPlayer/releases/tag/v1.1.23)**  
Download: `SSSPlayer-1.1.23.vpk`
...
- **Latest VPK:** [SSSPlayer-1.1.23.vpk](https://github.com/SergioSSantiago/SSSPlayer/releases/download/v1.1.23/SSSPlayer-1.1.23.vpk)
...
The packaged file is `SSSPlayer-1.1.23.vpk` (version embedded in the filename).
