...
**Latest release: [v1.1.24](https://github.com/SergioSSantiago/SSSPlayer/releases/tag/v1.1.24)**  
Download: `SSSPlayer-1.1.24.vpk`
...
- **Latest VPK:** [SSSPlayer-1.1.24.vpk](https://github.com/SergioSSantiago/SSSPlayer/releases/download/v1.1.24/SSSPlayer-1.1.24.vpk)
...
The packaged file is `SSSPlayer-1.1.24.vpk` (version embedded in the filename).
