...
**Latest release: [v1.1.21](https://github.com/SergioSSantiago/SSSPlayer/releases/tag/v1.1.21)**  
Download: `SSSPlayer-1.1.21.vpk`
...
- **Latest VPK:** [SSSPlayer-1.1.21.vpk](https://github.com/SergioSSantiago/SSSPlayer/releases/download/v1.1.21/SSSPlayer-1.1.21.vpk)
...
The packaged file is `SSSPlayer-1.1.21.vpk` (version embedded in the filename).
