...
**Latest release: [v1.1.22](https://github.com/SergioSSantiago/SSSPlayer/releases/tag/v1.1.22)**  
Download: `SSSPlayer-1.1.22.vpk`
...
- **Latest VPK:** [SSSPlayer-1.1.22.vpk](https://github.com/SergioSSantiago/SSSPlayer/releases/download/v1.1.22/SSSPlayer-1.1.22.vpk)
...
The packaged file is `SSSPlayer-1.1.22.vpk` (version embedded in the filename).
