...
**Latest release: [v1.1.15](https://github.com/SergioSSantiago/SSSPlayer/releases/tag/v1.1.15)**  
Download: `SSSPlayer-1.1.15.vpk`
...
- **Latest VPK:** [SSSPlayer-1.1.15.vpk](https://github.com/SergioSSantiago/SSSPlayer/releases/download/v1.1.15/SSSPlayer-1.1.15.vpk)
...
The packaged file is `SSSPlayer-1.1.15.vpk` (version embedded in the filename).
