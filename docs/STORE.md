...
| **Direct VPK** | https://github.com/SergioSSantiago/SSSPlayer/releases/download/v1.1.15/SSSPlayer-1.1.15.vpk |
...
- [ ] Link latest GitHub release / VPK (`SSSPlayer-1.1.15.vpk`)
- [ ] Upload icon0.png
- [ ] Upload screenshots
