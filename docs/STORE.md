...
| **Direct VPK** | https://github.com/SergioSSantiago/SSSPlayer/releases/download/v1.1.24/SSSPlayer-1.1.24.vpk |
...
- [ ] Link latest GitHub release / VPK (`SSSPlayer-1.1.24.vpk`)
- [ ] Upload icon0.png
- [ ] Upload screenshots
