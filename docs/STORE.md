...
| **Direct VPK** | https://github.com/SergioSSantiago/SSSPlayer/releases/download/v1.1.27/SSSPlayer-1.1.27.vpk |
...
- [ ] Link latest GitHub release / VPK (`SSSPlayer-1.1.27.vpk`)
- [ ] Upload icon0.png
- [ ] Upload screenshots
