...
| **Direct VPK** | https://github.com/SergioSSantiago/SSSPlayer/releases/download/v1.1.26/SSSPlayer-1.1.26.vpk |
...
- [ ] Link latest GitHub release / VPK (`SSSPlayer-1.1.26.vpk`)
- [ ] Upload icon0.png
- [ ] Upload screenshots
