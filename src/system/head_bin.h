/* Template head.bin from VitaShell (GPL-3.0). Used to generate package/head.bin before promote. */
static const unsigned char tpl_head_bin[] = {
...
static const unsigned int tpl_head_bin_len = 1072;
