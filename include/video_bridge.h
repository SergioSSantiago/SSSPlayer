...
/* Play a local video file with the VideoSSS decoder stack.
...
/* Open the VideoSSS local media browser (videos/images). */
int sss_video_browse_library(void);

/* Open the VideoSSS network sources browser (SMB/SFTP/WebDAV/Jellyfin). */
